...
\begin{cases}
f_{SPACE}(g_s) \sim 
BYM2\left(\sigma_{\text{SPACE}},\phi_{\text{SPACE}},R\right) \\
\mathrm{Corr}(f_{SPACE}(z_s, 1),f_{SPACE}(z_s, 2)) =\eta_{f_{\text{SPACE}}}
\end{cases}\\
\mathrm{Hyperparameters}
\begin{cases}
\eta_{f_{\text{SPACE}}}=  \frac{\exp(\eta_{f_{\text{SPACE}}}^*) - 1}{\exp(\eta_{f_{\text{SPACE}}}^*) + 2 - 1}\\
...
#NB: for grouping structure for BYM2 model:
https://mail.google.com/mail/u/0/#inbox/FMfcgzQZTMQQzvMCsRTqzlCgkTmSdSNz
```
