...
For identifiability a sum-to-zero constraint is imposed on the components of the iCAR/BYM model associated with each connected subgraph of the matrix $R$ \cite{Riebler2016}.
