...
* 26/02/2025: accepted for publication in Eurosurveillance


## Major updates

* 19/11/2025: Additional neighbourhood matrix (2nd-order Queen contiguity) considered. Replacement of the single-level prior of each of the three additional intercepts by a hierarchical prior (PC-prior). Results remain the same.
